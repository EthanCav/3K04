...
## Generated on : Mon Oct 17 19:04:45 2022
...
COMPILER_COMMAND_FILE     = Pacemaker_comp.rsp
CMD_FILE                  = Pacemaker.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Pacemaker.elf
...
DEFINES_STANDARD = -DMODEL=Pacemaker -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_PWM.o Pacemaker.o Pacemaker_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Pacemaker_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Pacemaker_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Pacemaker_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Pacemaker_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Pacemaker_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Pacemaker_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Pacemaker.o : $(START_DIR)/Pacemaker_ert_rtw/Pacemaker.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Pacemaker_data.o : $(START_DIR)/Pacemaker_ert_rtw/Pacemaker_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
