###########################################################################
## Makefile generated for component 'simulink_group46'. 
## 
## Makefile     : simulink_group46.mk
## Generated on : Mon Nov 14 17:02:16 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/simulink_group46.elf
...
PRODUCT_NAME              = simulink_group46
MAKEFILE                  = simulink_group46.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/kavya/OneDrive/DOCUME~1/GitHub/3K04/SIMULI~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = simulink_group46_comp.rsp
CMD_FILE                  = simulink_group46.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/simulink_group46.elf
...
DEFINES_ = -DMW_SERIAL0_RXBUF_SIZE=10 -DMW_SERIAL0_TXBUF_SIZE=132 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__
...
DEFINES_STANDARD = -DMODEL=simulink_group46 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_PWM.o MW_SCI.o MW_AnalogInput.o send_params.o simulink_group46.o simulink_group46_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/simulink_group46_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/simulink_group46_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/simulink_group46_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/simulink_group46_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/simulink_group46_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
mw_sdk_interface.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/freedomk64f/src/mw_sdk_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MW_PWM.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/freedomk64f/src/MW_PWM.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MW_SCI.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/freedomk64f/src/MW_SCI.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MW_AnalogInput.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/freedomk64f/src/MW_AnalogInput.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/simulink_group46_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


send_params.o : $(START_DIR)/simulink_group46_ert_rtw/send_params.c
	$(CC) $(CFLAGS) -o "$@" "$<"


simulink_group46.o : $(START_DIR)/simulink_group46_ert_rtw/simulink_group46.c
	$(CC) $(CFLAGS) -o "$@" "$<"


simulink_group46_data.o : $(START_DIR)/simulink_group46_ert_rtw/simulink_group46_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
board.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/freedomk64f/src/board.c
	$(CC) $(CFLAGS) -o "$@" "$<"


hardware_init.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/freedomk64f/src/hardware_init.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pin_mux.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/freedomk64f/src/pin_mux.c
	$(CC) $(CFLAGS) -o "$@" "$<"


fsl_misc_utilities.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/freedomk64f/src/fsl_misc_utilities.c
	$(CC) $(CFLAGS) -o "$@" "$<"


fsl_edma_irq.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/freedomk64f/src/fsl_edma_irq.c
	$(CC) $(CFLAGS) -o "$@" "$<"


fsl_uart_irq.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/freedomk64f/src/fsl_uart_irq.c
	$(CC) $(CFLAGS) -o "$@" "$<"


irq_stub.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/freedomk64f/src/irq_stub.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sbrk.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/freedomk64f/src/sbrk.c
	$(CC) $(CFLAGS) -o "$@" "$<"


cmsis_rtos_init.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/armcortexmbase/cmsis_rtos_rtx/src/cmsis_rtos_init.c
	$(CC) $(CFLAGS) -o "$@" "$<"


RTX_Conf_CM.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/3P.instrset/cmsis.instrset/CMSIS/RTOS/RTX/Templates/RTX_Conf_CM.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mw_thread.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/armcortexmbase/cmsis_rtos_rtx/src/mw_thread.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mw_semaphore.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/armcortexmbase/cmsis_rtos_rtx/src/mw_semaphore.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mw_timer.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/armcortexmbase/cmsis_rtos_rtx/src/mw_timer.c
	$(CC) $(CFLAGS) -o "$@" "$<"
