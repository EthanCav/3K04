###########################################################################
## Makefile generated for component 'Serial_example'. 
## 
## Makefile     : Serial_example.mk
## Generated on : Mon Nov 21 16:46:49 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Serial_example.elf
...
COMPILER_COMMAND_FILE     = Serial_example_comp.rsp
CMD_FILE                  = Serial_example.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Serial_example.elf
...
DEFINES_ = -DMW_SERIAL0_RXBUF_SIZE=11 -DMW_SERIAL0_TXBUF_SIZE=9 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__
...
DEFINES_STANDARD = -DMODEL=Serial_example -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SCI.o MW_digitalIO.o mw_sdk_interface.o Serial_example.o Serial_example_data.o send_params.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Serial_example_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Serial_example_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Serial_example_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Serial_example_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Serial_example_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Serial_example_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Serial_example.o : $(START_DIR)/Serial_example_ert_rtw/Serial_example.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Serial_example_data.o : $(START_DIR)/Serial_example_ert_rtw/Serial_example_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


send_params.o : $(START_DIR)/Serial_example_ert_rtw/send_params.c
	$(CC) $(CFLAGS) -o "$@" "$<"
