###########################################################################
## Makefile generated for component 'accel_3'. 
## 
## Makefile     : accel_3.mk
## Generated on : Mon Nov 28 21:24:45 2022
## Final product: ./accel_3_rtwlib.lib
...
COMPILER_COMMAND_FILE     = accel_3_comp.rsp
CMD_FILE                  = accel_3.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = accel_3_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=accel_3 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = i2c_api.o MW_I2C.o mw_sdk_interface.o accel_3.o
...
%.o : $(START_DIR)/slprj/ert/accel_3/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/accel_3/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/accel_3/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/accel_3/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/accel_3/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
accel_3.o : $(START_DIR)/slprj/ert/accel_3/accel_3.c
	$(CC) $(CFLAGS) -o "$@" "$<"
