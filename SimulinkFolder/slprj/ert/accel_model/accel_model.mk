###########################################################################
## Makefile generated for component 'accel_model'. 
## 
## Makefile     : accel_model.mk
## Generated on : Mon Nov 28 17:05:45 2022
## Final product: ./accel_model_rtwlib.lib
...
COMPILER_COMMAND_FILE     = accel_model_comp.rsp
CMD_FILE                  = accel_model.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = accel_model_rtwlib.lib
...
PRODUCT = ./accel_model_rtwlib.lib
...
OBJS = i2c_api.o MW_I2C.o mw_sdk_interface.o accel_model.o
...
%.o : $(START_DIR)/slprj/ert/accel_model/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/accel_model/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/accel_model/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/accel_model/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/accel_model/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
i2c_api.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/freedomk64f/src/i2c_api.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MW_I2C.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/freedomk64f/src/MW_I2C.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
accel_model.o : $(START_DIR)/slprj/ert/accel_model/accel_model.c
	$(CC) $(CFLAGS) -o "$@" "$<"
