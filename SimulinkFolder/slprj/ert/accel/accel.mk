###########################################################################
## Makefile generated for component 'accel'. 
## 
## Makefile     : accel.mk
## Generated on : Mon Nov 28 20:54:46 2022
## Final product: ./accel_rtwlib.lib
...
OBJS = i2c_api.o MW_I2C.o mw_sdk_interface.o accel.o
...
%.o : $(START_DIR)/slprj/ert/accel/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/accel/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/accel/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/accel/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/accel/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
accel.o : $(START_DIR)/slprj/ert/accel/accel.c
	$(CC) $(CFLAGS) -o "$@" "$<"
